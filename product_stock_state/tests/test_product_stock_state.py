...
class TestProductStockState(TransactionCase):
    ...
    def setUp(self):
        ...
        self.product_by_categ_direct = self.env.ref(
            'stock.product_icecream')
    ...
    def test_04_category_setting_inherit(self):
        ...
        self.assertEqual(
            self.product_by_product._get_stock_state_threshold(),
            30)

    def test_05_state_out_of_stock(self):
        """Test Stock State computation"""
        self.assertEqual(
            self.product_by_product.stock_state, 'out_of_stock')
