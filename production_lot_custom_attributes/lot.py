...
class stock_production_lot(Model):
    ...
    #     """Find Attribute Groups for this Lot
    ...
    #         context = {}
    #     res = {}
    #     attr_group_pool = self.pool.get('attribute.group')

    #     for lot in self.browse(cr, uid, ids, context=context):
    #         res[lot.id] = []
    #         if lot.attribute_set_id:
    #             res[lot.id] = attr_group_pool.search(cr, uid, [
    #                 ('attribute_set_id', '=', lot.attribute_set_id.id)
    #             ])
    #     return res
