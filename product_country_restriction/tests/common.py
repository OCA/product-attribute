...
class CountryRestrictionCommon(common.TransactionCase):
    def setUp(self):
        ...
        self.product_3 = self.env.ref("product.product_product_3").product_tmpl_id
        ...
        self.global_item = self.env["product.country.restriction.item"].create(vals)
        ...
        self.variant_item = self.env["product.country.restriction.item"].create(vals)
        ...
        self.product_item = self.env["product.country.restriction.item"].create(vals)
        ...
        self.category_item = self.env["product.country.restriction.item"].create(vals)
