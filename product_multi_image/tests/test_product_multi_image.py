...
class TestProductMultiImage(common.TransactionCase):
    ...
    def test_02_restrict_one_image(self):
    ...
    def test_03_add_image_variant(self):
        self.product_1.image_ids = [(0, 0, {"image_1920": self.grey_image})]
    ...
    def test_04_remove_image_variant(self):
    ...
    def test_09_image_product_variant_count(self):
    ...
    def test_10_post_init_hook_product(self):
    ...
    def test_11_post_init_hook_template(self):
