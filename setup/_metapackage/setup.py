...
setuptools.setup(
    ...
    install_requires=[
        ...
        'odoo-addon-product_attachment_link>=16.0dev,<16.1dev',
        ...
        'odoo-addon-product_compute_template_field_from_variant_helper>=16.0dev,<16.1dev',
        ...
        'odoo-addon-product_pricelist_item_uom>=16.0dev,<16.1dev',
        ...
        'odoo-addon-product_template_default_weight>=16.0dev,<16.1dev',
