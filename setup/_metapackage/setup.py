...
setuptools.setup(
    ...
    install_requires=[
        ...
        'odoo-addon-nutritional_info>=15.0dev,<15.1dev',
        'odoo-addon-nutritional_info_stock_lot>=15.0dev,<15.1dev',
        ...
        'odoo-addon-product_attachment_zipped_download>=15.0dev,<15.1dev',
        ...
        'odoo-addon-product_pricelist_discount_by_range>=15.0dev,<15.1dev',
        'odoo-addon-product_pricelist_item_list_view>=15.0dev,<15.1dev',
        ...
        'odoo-addon-product_status>=15.0dev,<15.1dev',
        ...
        'odoo-addon-sale_product_matrix_secondary_unit>=15.0dev,<15.1dev',
