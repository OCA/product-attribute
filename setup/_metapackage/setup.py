...
setuptools.setup(
    ...
    install_requires=[
        ...
        'odoo12-addon-product_dimension_compute_volume',
        'odoo12-addon-product_documentation_set',
        'odoo12-addon-product_end_of_life',
        ...
        'odoo12-addon-product_net_weight',
        ...
        'odoo12-addon-product_pricelist_show_product_ref',
