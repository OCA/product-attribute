...
class ProductScaleLog(models.Model):
    ...
    _TRANSLATED_TERM = {0x2018: 0x27, 0x2019: 0x27, 0x201C: 0x22, 0x201D: 0x22}
        ...
        for log in self:
            ...
            for product_line in group.scale_system_id.product_line_ids:
                ...
                if product_line.type == "id":
                    ...
                    external_texts.append(
                        self._generate_external_text(
                            product_line.constant_value, product_line, external_id, log
                        )
                    )
                    product_text += external_id
    ...
    def ftp_connection_open(self, scale_system, raise_error=False):
        ...
        _logger.info(
            "Trying to connect to ftp://%s@%s:%d"
    ...
    def ftp_connection_push_image_file(
        self, ftp, distant_folder_path, local_folder_path, obj, field, extension
    ):
