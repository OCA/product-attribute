# -*- coding: utf-8 -*-
# Copyright 2017 Jose Zambudio <jose.zambudio@diagram.es>
    ...
    def name_get(self):
        ...
        if partner_id:
            ...
            for product in self:
                ...
                result_tuple = filter(
                    lambda r: r[0] == product.id, last_result)
                if partner_ids:
                ...
                for customer in customers:
                    customer_variant = (
                        customer.product_name and (
                            variant and "%s (%s)" % (
                                customer.product_name, variant) or
                    ...
                    mydict = {
                        ...
                        'default_code': (
                            customer.product_code or product.default_code),
                    }
