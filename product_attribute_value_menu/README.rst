...
This module adds 2 ergonomic menus:
...
- A menu item in Sales and Inventory Applications called *Attribute
  Values*, located under the respective Configuration > Attributes' one, 
  like it was in previous Odoo versions. The new menu item contains all 
  the Attribute Values on a tree view, having the attribut associated
  with a link and the value.
