...
# Copyright 2021 Daniel Herreros <daniel.herreros@bt-group.com>
...
class ProductBrand(models.Model):
    ...
    partner_id = fields.Many2one('res.partner', string='Partner',
                                 ondelete='restrict',
                                 help='Select a partner for this'
                                      ' brand if any.')
    logo = fields.Binary('Logo File', attachment=True)
    product_ids = fields.One2many('product.template', 'product_brand_id',
