 ...
 %%(additional_tables)s
    ...
    def onchange_type_selection_id(self):
        ...
        if self.type_selection_id.product_category_this:
            this_product_domain.append((
                'categ_id', 'in',
                self.type_selection_id.product_category_this.ids))
        ...
        if self.type_selection_id.product_category_other:
            other_product_domain.append((
                'categ_id', 'in',
                self.type_selection_id.product_category_other.ids))
        result = {'domain': {
    ...
    def onchange_product_id(self):
        ...
        if self.this_product_id:
            type_selection_domain += [
                ...
                ('product_category_this', 'in',
                 self.this_product_id.categ_id.ids)]
        if self.other_product_id:
            type_selection_domain += [
                ...
                ('product_category_other', 'in',
                 self.other_product_id.categ_id.ids)]
        result = {'domain': {
