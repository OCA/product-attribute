...
[product_pricelist_direct_print](product_pricelist_direct_print/) | 15.0.1.1.0 |  | Print price list from menu option, product templates, products variants or price lists
