...
[product_attribute_custom_value_variant](product_attribute_custom_value_variant/) | 16.0.1.0.0 |  | When a custom value is assigned, create a variant instead.
[product_attribute_model_link](product_attribute_model_link/) | 16.0.1.0.2 |  | Use any model records as product attribute values
...
[product_ingredient](product_ingredient/) | 16.0.1.0.0 | <a href='https://github.com/sergio-teruel'><img src='https://github.com/sergio-teruel.png' width='32' height='32' style='border-radius:50%;' alt='sergio-teruel'/></a> | Product ingredients
...
[product_is_bulk](product_is_bulk/) | 16.0.2.0.1 | <a href='https://github.com/quentinDupont'><img src='https://github.com/quentinDupont.png' width='32' height='32' style='border-radius:50%;' alt='quentinDupont'/></a> | Compute or Set Product as Bulk
...
[product_packaging_dimension](product_packaging_dimension/) | 16.0.1.2.0 |  | Manage packaging dimensions and weight
[product_packaging_level](product_packaging_level/) | 16.0.1.2.2 |  | This module binds a product packaging to a packaging level
