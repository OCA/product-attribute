...
class TestProductPricelistItem(TransactionCase):
    ...
    def setUpClass(cls):
        ...
        # Needed until https://github.com/odoo/odoo/pull/145191 is merged
        cls.pricelist_item_uom_accuracy = cls.env["decimal.precision"].create(
            {
                "name": "Product Unit Of Measure",
                "digits": log10(cls.g_uom.factor),
            }
        )
