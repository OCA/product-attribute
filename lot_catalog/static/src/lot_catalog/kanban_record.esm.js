...
import {LotCatalogOrderLine} from "./order_line/order_line.esm";
import {rpc} from "@web/core/network/rpc";
import {useDebounced} from "@web/core/utils/timing";
import {useSubEnv} from "@odoo/owl";

export class LotCatalogKanbanRecord extends KanbanRecord {
    static template = "LotCatalogKanbanRecord";
    static components = {
    ...
    onGlobalClick(ev) {
        ...
        if (ev.target.closest(".o_lot_catalog_cancel_global_click")) {
            return;
        }
    ...
    _updateQuantityAndGetPrice() {
        return rpc(
            "/lot/catalog/update_order_line_info",
