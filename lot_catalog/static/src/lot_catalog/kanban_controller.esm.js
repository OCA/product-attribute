...
export class LotCatalogKanbanController extends KanbanController {
    static template = "LotCatalogKanbanController";
    ...
    setup() {
        ...
        this.orderResModel = this.props.context.lot_catalog_order_model;
